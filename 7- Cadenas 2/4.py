mensaje_original = str(input('Introduce una cadena: '))
mensaje_filtrado = mensaje_original

 # Lista de palabras malsonantes o patrones a buscar
malsonantes = ['palabra1', 'palabra2', 'palabra3']

# Reemplazar las palabras malsonantes con una carita feliz
# Para cada palabra malsonante que encuentre la reemplaza
